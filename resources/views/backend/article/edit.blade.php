...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div id="data" class="widget widget-default" data-id="{{ $article->id . '.by@' . request()->ip() }}">
                <div class="widget-header">
                    <h6><i class="fa fa-pencil  fa-fw"></i>编辑文章</h6>
                </div>
                <div class="widget-body edit-form">
                    <form role="form" class="form-horizontal" action="{{ route('article.update',$article->id) }}" method="post">
                        @include('backend.article.form-content')
