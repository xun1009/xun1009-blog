...
require('./hightlight.js');
require('./marked.js');
//window.autosize = window.autosize ? window.autosize : require('autosize');
window.autosize = window.autosize ? window.autosize : require('./autosize.min.js');
...
//     request.headers.set('X-CSRF-TOKEN',window.Laravel);
...
// Vue.component('comment-item', require('./components/comments/Comment-item.vue'));
...
(function ($) {
    ...
    function footerPosition(){
        ...
        if(!(contentHeight > winHeight)){
            ...
            $('footer').css({position:"absolute",bottom:'0',width:'100%',height:'60px'});
        }
    }
    footerPosition();
